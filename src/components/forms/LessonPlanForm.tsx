...
const lessonSchema = z.object({
  ...
  steps: z.object({
    step1: z.object({
      ...
      teacherActivities: z.array(z.string()).min(1, "Step I teacher activities are required"),
      studentActivities: z.array(z.string()).min(1, "Step I student activities are required"),
    }),
    step2: z.object({
      mode: z.string().min(1, "Step II mode is required"),
      teacherActivities: z.array(z.string()).min(1, "Step II teacher activities are required"),
      studentActivities: z.array(z.string()).min(1, "Step II student activities are required"),
    }),
    step3: z.object({
      mode: z.string().min(1, "Step III mode is required"),
      teacherActivities: z.array(z.string()).min(1, "Step III teacher activities are required"),
      studentActivities: z.array(z.string()).min(1, "Step III student activities are required"),
    }),
    step4: z.object({
      mode: z.string().min(1, "Step IV mode is required"),
      teacherActivities: z.array(z.string()).min(1, "Step IV teacher activities are required"),
      studentActivities: z.array(z.string()).min(1, "Step IV student activities are required"),
    }),
    step5: z.object({
      mode: z.string().min(1, "Step V mode is required"),
      teacherActivities: z.array(z.string()).min(1, "Step V teacher activities are required"),
      studentActivities: z.array(z.string()).min(1, "Step V student activities are required"),
    }),
  }),
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="flex space-x-4">
          ...
          <div className="flex-1">
            ...
            <input
              ...
              {...register("date")}
              className="mt-1 block w-full p-2 border rounded-md"
              placeholder="18th - 22nd January 2021"
            />
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            />
            {errors.subTopic && <p className="text-red-600 text-sm">{errors.subTopic.message}</p>}
          </div>
        </div>

        {/* Duration, Class, and Age Group */}
        <div className="flex space-x-4">
          <div className="flex-1">
          ...
          <div className="flex-1">
            ...
            />
            {errors.ageGroup && <p className="text-red-600 text-sm">{errors.ageGroup.message}</p>}
          </div>
        </div>
