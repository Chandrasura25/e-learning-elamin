...
const ViewForm = ({ note }) => {
  return (
    <div className="max-w-4xl mx-auto p-8 bg-white rounded-md shadow-lg">
      <h2 className="text-heading3-bold text-center mb-8">Lesson Plan</h2>
          ...
          Object.keys(note.steps).map((stepKey, index) => (
            <div key={index} className="mb-6">
              ...
              <div className="mt-4">
                ...
                <textarea
                  value={
                    note.steps[stepKey]?.teacherActivities?.join(", ") || "N/A"
                  }
                  disabled
                  className="mt-1 block w-full p-2 border rounded-md bg-gray-200"
                />
              ...
              <div className="mt-4">
                ...
                <textarea
                  value={
                    note.steps[stepKey]?.studentActivities?.join(", ") || "N/A"
                  }
                  disabled
                  className="mt-1 block w-full p-2 border rounded-md bg-gray-200"
                />
